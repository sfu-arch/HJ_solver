...
class MInputStoreQueueIO[T <: Data](private val gen: T, val entries: Int, NumIns: Int, NumOuts: Int) extends Bundle
{
...
class MInputStoreQueue[T <: Data](gen: T,
  ...
  val io = IO(new MInputStoreQueueIO(genType, entries, NumIns, NumOuts))
